...
class LineListAType
{
     ...
     * Factuurregel
     *
     * @property \MainlyCode\Reeleezee\ValueObject\PurchaseInvoiceLineType[] $line
     */
    private $line = null;
     ...
     */
    public function addToLine(\MainlyCode\Reeleezee\ValueObject\PurchaseInvoiceLineType $line)
    {
        $this->line[] = $line;
        return $this;
    }
